...
namespace Lykke.Service.PayVolatility
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        {                                   
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "PayVolatilityLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.PayVolatilityService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("PayVolatility", channelOptions =>
                        {
